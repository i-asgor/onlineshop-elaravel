                                ...
                                <table id="table_id" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" class="BannerStatus btn btn-success" rel="{{ $bannerDetail->id }}" data-toggle="toggle" data-on="Enabled" data-off="Disabled" data-onstyle="success" data-offstyle="danger" @if($bannerDetail['status']=="1") checked @endif>
