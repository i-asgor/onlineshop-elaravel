        ...
        <div class="row my-5">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="order-box">
                    ...
                    <div class="d-flex">
                        <h4>Sub Total</h4>
                        <div class="ml-auto font-weight-bold"> <?php echo $total_amount; ?> TK</div>
                    </div>

                    <hr class="my-1">
                    <div class="d-flex">
                        <h4>Coupon Discount</h4>
                        <div class="ml-auto font-weight-bold"> <?php echo Session::get('CouponAmount'); ?> TK</div>
                    </div>
                    ...
                    <div class="d-flex gr-total">
                        <h5>Grand Total</h5>
                        <div class="ml-auto h5"> <?php echo $total_amount - Session::get('CouponAmount'); ?> TK </div>
                    </div>
                    <hr>
                    @else
                    <div class="d-flex gr-total">
                        <h5>Grand Total</h5>
                        <div class="ml-auto h5"> <?php echo $total_amount; ?> TK </div>
                    </div>
                    @endif
                </div>
